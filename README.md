...
The 'dbt-workshop' project was generated by using the dbt template for
...
3. Install dbt
   ...
   Run these instructions from the `dbt-workshop` directory. We recommend making
...
`[dev yourname] dbt-workshop_job` to your workspace.
...
When deploying to this target, note that the default job at resources/dbt-workshop.job.yml
